...
<Navbar bg="dark" expand="lg" className='sticky-top' style={{height:"70px",color:"white"}}> 
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav text-white" >
          ...
          <Badge badgeContent={getdata.length} color="primary"
           ...
           onClick={handleClick}
          >
          <i class="fa-solid fa-cart-shopping n1" style={{fontSize:25,cursor:"pointer"}}></i>
        </Badge>
    ...
    {
      getdata.length ?
      <div className="card_detials" style={{width:"24rem",padding:10}}>
       <Table>
           <thead>
            <tr>
              <th>Photo</th>
                  ...
                  <tr>
                    <td>
                      <NavLink to={`/cart/${e.id}`} onClick={handleClose}>
                        ...
                        style={{width:"5rem",height:"5rem",objetFit:"cover"}} />
                        </NavLink>
                    </td>
                    <td>
                      <p>{e.rname}</p>
      ...
      <div className="card_detials d-flex justify-content-center align-items-center" style={{width:"24rem", padding:10,position:"relative"}}>
    ...
    {/* <Navbar bg="dark" variant="dark" style={{height:"60px"}}>
        <Container>
          <NavLink to="/" className="text-decoration-none text-light mx-3">Add To Crat</NavLink>
          <Nav className="me-auto">
